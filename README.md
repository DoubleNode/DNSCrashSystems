![DoubleNode Swift Framework](https://github.com/DoubleNode/DNSCrashSystems/raw/master/DNSFrameworkLogo.png)
...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSCrashSystems.git", from: "1.4.0")
]
```

## Dependencies

-   DNSBlankSystems v1.4.0+
-   DNSError v1.4.0+
-   DNSProtocols v1.4.0+
